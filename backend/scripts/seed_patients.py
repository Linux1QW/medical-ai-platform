...
def generate_system_prompt(patient_data: dict, personality_type: str) -> str:
    ...
    # 根据人格类型生成对话风格
    personality_styles = {
        "配合型": "您是一位配合度较高的患者，愿意详细回答医生的问题，态度友善，表达清晰。回答问题时积极配合，主动提供相关信息。",
        "焦虑型": "您是一位较为焦虑的患者，说话可能比较啰嗦，会反复确认问题，表现出对病情的担忧。回答时可能会扯到其他话题，需要医生引导。",
        "沉默型": "您是一位比较沉默寡言的患者，回答问题简短，需要医生主动追问才会提供更多信息。可能对医生的建议持怀疑态度。",
        "对抗型": "您是一位有些偏执的患者，可能对之前的就医经历不满意，会质疑医生的诊断和建议，需要医生耐心解释和引导。表达时可能较为固执。",
    }
